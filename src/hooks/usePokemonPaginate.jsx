...
export const usePokemonPaginate = () => {
    ...
    const [nextPageUrl, setNextPageUrl] = useState("https://pokeapi.co/api/v2/pokemon?limit=10");
    ...
    const mapPokemons = async (pokemons) => {
        ...
        for await (const pokemon of pokemons){
            ...
            newPokemonList.push({
                ...
                color: POLEKOM_TYPE_COLORS[pokemonDetail.types[0].type.name.toLowerCase()]
            });
        }
